...
/**
 * @Class Name : ParkTypeService.java
 * @Description : ParkTypeService Class
...
public interface ParkTypeService {
	 ...
	 * @exception Exception
	 */
	List<?> selectParkTypeList(ParkTypeDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
	int selectParkTypeListTotCnt(ParkTypeDefaultVO searchVO);
