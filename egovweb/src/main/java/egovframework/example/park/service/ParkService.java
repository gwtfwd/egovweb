...
/**
 * @Class Name : ParkService.java
 * @Description : ParkService Class
...
public interface ParkService {
	 ...
	 * @exception Exception
	 */
	List<?> selectParkList(ParkDefaultVO searchVO) throws Exception;
	 ...
	 * @exception
	 */
	int selectParkListTotCnt(ParkDefaultVO searchVO);
